...
export default function RootLayout() {
  return (
    <section className="font-montserrat bg-graybg min-h-screen flex flex-col">
      <header>
      ...
      <main className="max-2xl:mx-20  max-container flex-grow">
      ...
      <footer className="bg-primary h-28 mt-auto flex justify-evenly items-center flex-shrink-0 max-sm:flex-col">
